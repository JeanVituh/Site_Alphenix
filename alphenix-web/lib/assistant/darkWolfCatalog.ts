...
export const DARK_WOLF_CATALOG_KNOWLEDGE: Record<string, DarkWolfCatalogKnowledge> = {
  'whey-100-pure-dark-wolf': {
    sourcePage: 3,
    description:
      'Whey 100% Pure Dark Wolf de 900g, formulado exclusivamente com proteínas do soro do leite. O catálogo informa 26g de proteína, 2g de glutamina e 5,8g de BCAA por dose e declara ausência de amino spiking.',
    benefits: [
  ...
  'beef-protein-juice-dark-wolf': {
    sourcePage: 4,
    description:
      'Beef Protein Juice Dark Wolf de 900g, proteína em perfil refrescante. O catálogo informa 32g de proteína por porção, zero açúcar, zero glúten e zero lactose.',
    benefits: [
  ...
  'whey-protein-evolut-dark-wolf': {
    sourcePage: 5,
    description:
      'Whey Protein Evolut Dark Wolf de 900g, combinando proteína concentrada do soro do leite e colágeno hidrolisado. O catálogo informa 22g de proteína e 128 kcal por dose, baixo teor de gorduras e zero glúten.',
    benefits: [
      '22g de proteína por dose',
      'Proteína concentrada do soro do leite + colágeno hidrolisado',
      'Suporte à recuperação muscular',
      'Baixo teor de gorduras segundo o catálogo',
      'Zero glúten',
    ],
  ...
  'creatina-dark-wolf': {
    sourcePage: 6,
    description:
      'Creatina monohidratada Dark Wolf com laudo de pureza apresentado no catálogo, matéria-prima importada e versões de 300g e 500g. O catálogo a posiciona para força, potência, desempenho e recuperação muscular.',
    benefits: [
      ...
      'Zero açúcar e sem glúten segundo o catálogo',
    ],
    facts: ['creatina monohidratada', 'versões 300g e 500g no catálogo', 'matéria-prima importada', 'laudo apresentado pela marca'],
    tags: ['creatina', 'forca', 'potencia', 'desempenho', 'recuperacao muscular', 'massa magra', 'custo beneficio'],
  },
  'creatina-gummy-dark-wolf': {
    sourcePage: 7,
    description:
      'Creatina Gummy Dark Wolf em formato de gomas, com 60 unidades (240g) e sabores maçã verde, laranja e uva verde no catálogo. A marca apresenta laudo de pureza e posiciona o produto como alternativa prática à creatina em pó.',
    benefits: [
      'Formato em gomas para maior praticidade',
      'Suporte à força e potência muscular',
      'Suporte ao desempenho físico',
      'Apoio à recuperação muscular',
      'Zero açúcar segundo o catálogo',
    ],
  ...
  'alcateia-pre-workout-dark-wolf': {
    sourcePage: 8,
    description:
      'Alcateia Pré-Workout Dark Wolf de 300g, pré-treino estimulante voltado a energia, foco, resistência e pump. O catálogo informa 400mg de cafeína, 2.000mg de beta-alanina, 2.000mg de taurina e 1.000mg de L-arginina na porção indicada.',
    benefits: [
      ...
      'Pré-treino com alta carga de cafeína segundo o catálogo',
    ],
  ...
  'alpha-burn-dark-wolf': {
    sourcePage: 9,
    description:
      'Alpha Burn Dark Wolf com 60 cápsulas, termogênico que a marca posiciona para definição, foco e energia. O catálogo também menciona suporte ao controle de apetite e à redução de retenção de líquidos.',
    benefits: [
      'Termogênico voltado a definição e energia',
      'Suporte ao foco e concentração',
      'A marca o posiciona como apoio ao controle de apetite',
      'A marca o posiciona como apoio à redução de retenção de líquidos',
      'Opção da categoria Termogênicos & Energia',
    ],
    facts: ['60 cápsulas', '5 ingredientes selecionados segundo o catálogo'],
  ...
  'multivitaminico-az-dark-wolf': {
    sourcePage: 10,
    description:
      'Multivitamínico AZ Dark Wolf com 90 cápsulas e 20 vitaminas e minerais. O catálogo informa 100% do valor diário dos micronutrientes apresentados em uma cápsula e o posiciona para suporte diário de energia, imunidade, disposição e recuperação.',
    benefits: [
    ...
    facts: ['90 cápsulas', '20 vitaminas e minerais', 'catálogo informa 100% do VD em 1 cápsula'],
    tags: ['multivitaminico', 'saude geral', 'imunidade', 'energia', 'disposicao', 'pele', 'cabelo', 'recuperacao'],
  },
  'multivitaminico-kids-az-dark-wolf': {
    sourcePage: 11,
    description:
      'Multivitamínico Kids Dark Wolf em gomas sabor framboesa, com 30 unidades e 19 vitaminas e minerais. O catálogo o posiciona para suporte nutricional durante a fase de crescimento, energia, imunidade e bem-estar.',
    benefits: [
  ...
  'cafeina-pura-200mg-dark-wolf': {
    sourcePage: 12,
    description:
      'Cafeína Pura Dark Wolf com 90 cápsulas de 200mg, estimulante voltado a alerta, foco, energia e desempenho físico. O catálogo também a posiciona como opção termogênica.',
    benefits: [
    ...
    facts: ['90 cápsulas', '200mg de cafeína por cápsula segundo o produto/catalogação'],
  ...
  'sleep-zen-dark-wolf': {
    sourcePage: 13,
    description:
      'Sleep Zen Dark Wolf com 60 cápsulas, formulado com triptofano, magnésio, inositol, complexo B e melatonina. O catálogo o posiciona para relaxamento, qualidade do sono e recuperação do corpo.',
    benefits: [
      ...
      'Contém complexo B e melatonina segundo o catálogo',
    ],
  ...
  'neuro-focus-dark-wolf': {
    sourcePage: 14,
    description:
      'Neuro Focus Dark Wolf com 60 cápsulas, formulado com L-tirosina, taurina, colina, cafeína e coenzima Q10. O catálogo o posiciona para foco, atenção, concentração e desempenho mental em tarefas diárias.',
    benefits: [
  ...
  'omega-3-1000mg-dark-wolf': {
    sourcePage: 15,
    description:
      'Ômega 3 Dark Wolf com 120 cápsulas. O catálogo informa 1.000mg de óleo de peixe, 540mg de EPA e 360mg de DHA na porção apresentada e o posiciona para suporte cardiovascular, cognitivo e ao equilíbrio geral do organismo.',
    benefits: [
      'Fonte de EPA e DHA',
  ...
  'mag-six-dark-wolf': {
    sourcePage: 16,
    description:
      'Mag-Six Dark Wolf com 90 cápsulas e seis formas de magnésio: óxido, taurato, citrato malato, malato, ascorbato e bisglicinato. O catálogo relaciona a fórmula a metabolismo, função neuromuscular, saúde óssea, relaxamento, sono, energia e foco.',
    benefits: [
    ...
    facts: ['90 cápsulas', '6 formas de magnésio', 'zero açúcar', 'sem glúten e lactose segundo o catálogo'],
    tags: ['magnesio', 'sono', 'relaxamento', 'energia', 'fadiga muscular', 'foco', 'ossos', 'saude ossea', 'imunidade'],
  },
  'magnesio-inositol-dark-wolf': {
    sourcePage: 17,
    description:
      'Magnésio Inositol Dark Wolf de 210g, voltado a relaxamento físico e mental, qualidade do sono e suporte cognitivo. O catálogo menciona foco, memória e redução de fadiga muscular.',
    benefits: [
      ...
      'Zero açúcar e sem glúten/lactose segundo o catálogo',
    ],
    facts: ['210g', 'magnésio + inositol', 'zero açúcar', 'sem glúten e lactose segundo o catálogo'],
    tags: ['magnesio', 'inositol', 'sono', 'relaxamento', 'foco', 'memoria', 'fadiga muscular'],
  },
  'magnesio-l-treonato-ultra-dark-wolf': {
    sourcePage: 18,
    description:
      'Magnésio L-Treonato Ultra Dark Wolf com 60 cápsulas. O catálogo o posiciona para suporte às funções cognitivas, aprendizado, memória e para uma rotina noturna mais tranquila.',
    benefits: [
      'Suporte às funções cognitivas',
      'Apoio à memória e aprendizado',
      'Apoio ao relaxamento mental',
      'Suporte à qualidade do sono',
      'Sem glúten e lactose segundo o catálogo',
    ],
    facts: ['60 cápsulas', 'magnésio L-treonato', 'zero açúcar', 'sem glúten e lactose segundo o catálogo'],
  ...
  'picolinato-de-cromo-250mcg-dark-wolf': {
    ...
    benefits: [
      ...
      'A marca o posiciona como apoio ao controle de apetite',
      'A marca o posiciona como apoio ao gerenciamento de peso',
      'Pode ser considerado quando o cliente menciona vontade de doces, sem promessa de resultado',
      'Zero açúcar e sem glúten/lactose segundo o catálogo',
    ],
    facts: ['90 cápsulas', '250mcg de cromo', 'zero açúcar', 'sem glúten e lactose segundo o catálogo'],
  ...
  'coenzima-q10-100mg-dark-wolf': {
    sourcePage: 20,
    description:
      'Coenzima Q10 Dark Wolf 100mg com 60 cápsulas. O catálogo a posiciona para suporte à produção de energia, resistência, proteção antioxidante e saúde cardiovascular.',
    benefits: [
  ...
  'coenzima-q10-200mg-dark-wolf': {
    sourcePage: 21,
    description:
      'Coenzima Q10 Dark Wolf 200mg com 60 cápsulas. O catálogo destaca seu papel na produção de energia celular e proteção antioxidante e a posiciona para energia, resistência, saúde cardiovascular e vitalidade.',
    benefits: [
      'Suporte à produção de energia celular',
      'Apoio à resistência física',
      'Proteção antioxidante',
      'Suporte à saúde cardiovascular',
      'Opção de maior concentração de CoQ10 no catálogo Dark Wolf',
    ],
  ...
  'vitamina-d3-2000ui-dark-wolf': {
    sourcePage: 22,
    description:
      'Vitamina D3 Dark Wolf 2000UI com 90 cápsulas. O catálogo relaciona a vitamina D3 a suporte à saúde óssea e muscular e ao funcionamento do sistema imunológico.',
    benefits: [
      'Suporte à saúde óssea',
  ...
  'melatonina-liquida-dark-wolf': {
    sourcePage: 24,
    description:
      'Melatonina Líquida Dark Wolf em frasco de 30ml. O catálogo informa 600 porções/gotas e 0,21mg de melatonina por gota e a relaciona à regulação do ciclo sono-vigília e à qualidade do descanso.',
    benefits: [
      ...
      'Informação objetiva de concentração disponível no catálogo',
    ],
    facts: ['30ml', '600 porções/gotas no catálogo', '0,21mg de melatonina por gota segundo a tabela do catálogo'],
    tags: ['melatonina', 'sono', 'dormir', 'ciclo do sono', 'descanso', 'bem estar'],
  },
  'nac-600mg-dark-wolf': {
    sourcePage: 25,
    description:
      'NAC Dark Wolf com 60 cápsulas de 600mg de N-acetil L-cisteína. O catálogo o posiciona para suporte antioxidante, produção de glutationa, saúde celular, função respiratória e recuperação em rotinas intensas.',
    benefits: [
  ...
  'vitamina-b12-metilcobalamina-dark-wolf': {
    sourcePage: 26,
    description:
      'Vitamina B12 Metilcobalamina Dark Wolf com 120 cápsulas. O catálogo destaca o papel da B12 no metabolismo energético, formação de glóbulos vermelhos e funcionamento do sistema nervoso, além de foco e concentração.',
    benefits: [
  ...
  'trans-resveratrol-dark-wolf': {
    sourcePage: 27,
    description:
      'Trans Resveratrol Dark Wolf com 60 cápsulas. A tabela do catálogo informa 30mg de trans-resveratrol por cápsula e o posiciona para suporte antioxidante, saúde celular, equilíbrio metabólico, saúde cardiovascular e pele.',
    benefits: [
      'Ação antioxidante',
    ...
    facts: ['60 cápsulas', '30mg de trans-resveratrol por cápsula segundo a tabela do catálogo'],
  ...
  'vitamina-c-1000mg-dark-wolf': {
    sourcePage: 28,
    description:
      'Vitamina C Dark Wolf com 60 cápsulas de 1000mg. O catálogo destaca suporte ao sistema imunológico, proteção antioxidante, absorção de ferro, formação de colágeno e manutenção da saúde da pele.',
    benefits: [
      'Suporte ao sistema imunológico',
      'Ação antioxidante',
